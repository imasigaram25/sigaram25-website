...
export default function CoordinatorLogin() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // Check Role - Database usually uses 'organizer'
      ...
      toast({
        ...
        description: "Entering event management system...",
    ...
    <div className="min-h-screen bg-indigo-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 border border-indigo-100">
        <div className="flex flex-col items-center mb-8 text-center">
          ...
          <p className="text-gray-500 text-sm mt-2">Event Management Portal</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div className="space-y-2">
            ...
            <Input 
              type="email" 
              placeholder="coordinator@imahosur.com"
              value={email}
